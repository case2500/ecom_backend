...
//   .then(() => {
//     app.listen(4000);
//     console.log("Database is connected! Listening to localhost 4000 MONGODB_URI=mongodb://localhost:27017/ecom");
//   })
//   .catch((err) => console.log(err));
	...
	try {
		mongoose.connect(`mongodb://localhost:27017/ecom`, connectionParams);
